...
object CommunicationConstants {
    ...
    const val KEY_MSG_SENDER = "sender"
    const val KEY_MSG_TEXT = "text"
    const val KEY_MSG_TIMESTAMP = "ts"
    const val TYPE_ACTION_TRIGGER = "action_trigger"
    const val KEY_ACTION_INDEX = "actionIndex"
    const val KEY_ACTIONS = "actions"
    const val KEY_ACTION_LABEL = "label"
